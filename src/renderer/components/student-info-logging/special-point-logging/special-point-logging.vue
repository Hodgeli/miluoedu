<!--<template>-->
    <!--<div class="special-point-logging">-->
        <!--<div class="control-wrapper">-->
            ...
            <!--&lt;!&ndash;<el-input class="file-input" type="file" multiple="false" id="sheetjs-input" accept="xls,xlsx" @change="onchange"></el-input>&ndash;&gt;-->
        ...
        <!--<div class="table-wrapper">-->
            ...
            <!--<el-table-->
                ...
                <!--<el-table-column-->
                    ...
                    <!--<template scope="scope">-->
                        ...
                        <!--&lt;!&ndash;<el-input  v-model="scope.row.姓名" v-if="scope.row.姓名"&ndash;&gt;-->
                        <!--&lt;!&ndash;@blur="loseFcous(scope.$index, scope.row)" > </el-input>&ndash;&gt;-->
                        <!--&lt;!&ndash;<span style="margin-left: 10px" v-else>{{ scope.row.姓名 }}</span>&ndash;&gt;-->
                    <!--</template>-->
                <!--</el-table-column>-->
                <!--<el-table-column-->
                        <!--prop="学号"-->
            ...
            <!--</el-pagination>-->
        <!--</div>-->
        <!--&lt;!&ndash;<div id="out-table" v-show="false"></div>&ndash;&gt;-->
    <!--</div>-->
<!--</template>-->
